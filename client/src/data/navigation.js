...
export const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Broward County SO", to: "/departments/bso", icon: "Shield" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Assigned Vehicles", to: "/development/assigned-vehicles", icon: "Car" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Store Management", to: "/management/store", icon: "ShoppingCart", permission: "store.manage" },
