...
export const DEPARTMENTS = [
  ...
  { id: "dhs", label: "Department of Homeland Security", abbr: "DHS", division: "federal", tone: "amber" },
...
export const ROLE_MAP = [
  ...
  { roleId: "100000000000000032", key: "dhs_agent", department: "dhs", rank: "Agent", rankFull: "Special Agent", order: 100, displayTemplate: "{callsign} | {rank} | {surname}" },
  { roleId: "100000000000000033", key: "dhs_senior_agent", department: "dhs", rank: "Sr. Agent", rankFull: "Senior Special Agent", order: 110, displayTemplate: "{callsign} | {rank} | {surname}" },
  { roleId: "100000000000000034", key: "dhs_supervisor", department: "dhs", rank: "Sup. Agent", rankFull: "Supervisory Agent", order: 120, displayTemplate: "{callsign} | {rank} | {surname}" },
  { roleId: "100000000000000035", key: "dhs_director", department: "dhs", rank: "Director", rankFull: "Director", order: 130, displayTemplate: "{callsign} | {rank} | {surname}" },
...
export const roster = [
  ...
  { id: "rm-17", discordId: "402118844500000923", characterName: "Toby Marsh", displayName: "2-D-40 | Deputy | Marsh", department: "hcso", rank: "Deputy", rankFull: "Deputy", callsign: "2-D-40", status: "Leave", joinedAt: "2025-08-01", syncedAt: "2026-08-12T10:07:00Z", source: "manual" },
  ...
  { id: "rm-26", discordId: "402118844500000950", characterName: "Rosalind Achebe", displayName: "5-D-1 | Director | Achebe", department: "dhs", rank: "Director", rankFull: "Director", callsign: "5-D-1", status: "Active", joinedAt: "2025-01-08", syncedAt: "2026-08-22T18:04:00Z", source: "discord-sync" },
  { id: "rm-27", discordId: "402118844500000951", characterName: "Ellis Prator", displayName: "5-A-4 | Sr. Agent | Prator", department: "dhs", rank: "Sr. Agent", rankFull: "Senior Special Agent", callsign: "5-A-4", status: "Active", joinedAt: "2025-02-27", syncedAt: "2026-08-22T18:04:00Z", source: "discord-sync" },
