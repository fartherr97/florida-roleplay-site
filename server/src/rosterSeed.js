...
export const DEPARTMENTS = [
  ...
  { id: "bcso", label: "Broward County Sheriff's Office", abbr: "BCSO", division: "law", tone: "green" },
...
export const ROLE_MAP = [
  ...
  { roleId: "100000000000000011", key: "bcso_deputy", department: "bcso", rank: "Deputy", rankFull: "Deputy", order: 100, displayTemplate: "{callsign} | {rank} | {surname}" },
  { roleId: "100000000000000012", key: "bcso_master_deputy", department: "bcso", rank: "M. Deputy", rankFull: "Master Deputy", order: 105, displayTemplate: "{callsign} | {rank} | {surname}" },
  { roleId: "100000000000000013", key: "bcso_corporal", department: "bcso", rank: "Cpl.", rankFull: "Corporal", order: 110, displayTemplate: "{callsign} | {rank} | {surname}" },
  { roleId: "100000000000000014", key: "bcso_sergeant", department: "bcso", rank: "Sgt.", rankFull: "Sergeant", order: 115, displayTemplate: "{callsign} | {rank} | {surname}" },
  { roleId: "100000000000000015", key: "bcso_lieutenant", department: "bcso", rank: "Lt.", rankFull: "Lieutenant", order: 120, displayTemplate: "{callsign} | {rank} | {surname}" },
  { roleId: "100000000000000016", key: "bcso_major", department: "bcso", rank: "Maj.", rankFull: "Major", order: 125, displayTemplate: "{callsign} | {rank} | {surname}" },
  { roleId: "100000000000000017", key: "bcso_sheriff", department: "bcso", rank: "Sheriff", rankFull: "Sheriff", order: 130, displayTemplate: "{callsign} | {rank} | {surname}" },
