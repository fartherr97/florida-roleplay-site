 ...
 * weapons) and 009 (real imported BCSO/FHP vehicles). Keep the two in sync.
 */
...
export const ROLES = [
  ...
  { key: "bcso", name: "BCSO", kind: "department", priority: 15, is_department: true, inherits: null },
...
export const PERMISSIONS = [
  ...
  { key: "vehicle.bcso.patrol", description: "Spawn BCSO patrol vehicles", category: "vehicle", default_effect: "deny" },
  { key: "vehicle.bcso.supervisor", description: "Spawn BCSO supervisor vehicles", category: "vehicle", default_effect: "deny" },
  { key: "vehicle.bcso.command", description: "Spawn BCSO command vehicles", category: "vehicle", default_effect: "deny" },
...
export const ROLE_PERMISSIONS = [
  ...
  { role_key: "bcso", permission_key: "vehicle.bcso.patrol", effect: "allow" },
...
export const PAY_RATES = [
  ...
  { role_key: "bcso", hourly_cents: 15000, enabled: true },
...
/* ---- Vehicles (real imported BCSO/FHP spawns; MPD none yet) --------------- */
...
export const VEHICLES = [
  ...["a", "b", "c", "d", "e", "f", "g", "h"].map((s) => veh(`hcso1${s}`, "BCSO", `BCSO Unit (hcso1${s})`)),
