/**
 * Roster helpers — an exact copy of client/src/lib/roster.js.
 *
 * The nickname this builds is what the Discord bot applies as a member's server
 * nickname, and what the roster displays. The two copies are intentionally
 * duplicated rather than shared through a package: if you change one, change the
 * other, or the site and Discord will disagree about someone's name.
 */
