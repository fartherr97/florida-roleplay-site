 ...
 *
 * An exact copy of client/src/lib/departmentConfig.js. Intentionally duplicated
 * rather than shared through a package: the two must agree about who may do
 * what, so if you change one, change the other.
 *
