...
import { fetchPlayerMeta } from "../lib/playerMeta.js";
import {
  ACTION_TYPE_MAP,
  ACTION_BODY_MAP,
  DEFAULT_WINDOW_DAYS,
...
router.get("/bot/background/:discordId", requireBot, async (req, res) => {
  ...
  // Best-effort player metadata (play time, join date, last connection) mirrored
  // from the FiveM `players` table. Null until the game pushes it; never blocks.
